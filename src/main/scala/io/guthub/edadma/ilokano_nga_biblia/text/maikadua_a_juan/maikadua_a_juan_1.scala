package io.guthub.edadma.ilokano_nga_biblia.text.maikadua_a_juan

val maikadua_a_juan_1 =
...
<h1>Maikadua a Surat ni Juan</h1>
<h3>Kablaaw</h3>
<p class=""><sup class="mr-px" id="1">1</sup>Ti panglakayen iti napili a babai ken dagiti annakna, nga ay-ayatek iti kinapudno, ken saan laeng a siak, no di ket uray dagiti amin a makaammo iti kinapudno,
...
<sup class="mr-px" id="8">8</sup>Agbantaykayo, tapno saanyo a mapukaw ti nagtrabahoantayo, no di ket makagun-odkayo iti naan-anay a gunggona.
<sup class="mr-px" id="9">9</sup>Tunggal maysa nga agtultuloy ken saan nga agtalinaed iti pannursuro ni Kristo, awan ti Dios. Siasinoman nga agtalinaed iti pannursuro, addaan iti Ama ken Anak.
<sup class="mr-px" id="10">10</sup>No adda umay kadakayo ket dina iyeg daytoy a pannursuro, saanyo nga awaten iti balayyo wenno ikkan iti aniaman a kablaaw,
<sup class="mr-px" id="11">11</sup>ta siasinoman a mangkablaaw kenkuana makipaset kadagiti dakes nga aramidna.</p>
<h3>Maudi a Kablaaw</h3>
<p class=""><sup class="mr-px" id="12">12</sup>Nupay adu ti maisuratko kadakayo, kaykayatko ti saan nga agusar iti papel ken tinta. Namnamaek ketdi nga umasideg kadakayo ket makisaritaak a rupanrupa, tapno naan-anay ti ragsakmi.</p>
<p class="indent-8"><sup class="mr-px" id="13">13</sup>Kablaawannaka dagiti annak ti napili a kabsatmo a babai.</p>
</div>"""